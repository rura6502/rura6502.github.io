...
Testcontainers(https://www.testcontainers.org/)는 de facto로 사용되는 도커를 사용해서 필요로하는 특정 시스템의 이미지를 테스트시에 구동시키고 테스트가 종료되면 지워주는 라이브러리이다. 
![enter image description here](https://github.com/rura6502/rura6502.github.io/blob/master/_posts/_image/finally-easy-integration-testing-with-testcontainers-8-638.jpg?raw=true)
도커 자체가 이미 독립성이 보장되는 환경이기 때문에 외부 환경의 영향 없이 기능에 대한 테스트를 진행할 수 있다. 이미 엄청나게 많은 종류의 컴포넌트에 대한 전용 API를 제공할 뿐만 아니라 General 형태의 container 또한 구동이 가능하여 활용 형태가 무궁무진하다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU5NzYzNTM5MCwtMTM1NzUyMjc2LC0xMD
M1OTA4MzMzLDEzNDE4NzAxNDksLTMwMzg4NzI4NCwtOTUzOTMx
MTg0LC0xMDgzNTU2OTg2LDEzMjM1MDQ0MzFdfQ==
-->
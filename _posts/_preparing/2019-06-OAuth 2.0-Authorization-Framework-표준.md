...
OAuth는 이러한 이슈들을 autorization layer를 분리하고 client에게 Resource Owner로 부터 부여된 적절한 권한을 할당함으로써 풀 수 있다. OAuth는 Resource Owner에 의해서 관리되고, Resource Server로부터 제공되는 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM3MDQ4Mzk5NCw0ODM4ODIzNDQsLTcyNj

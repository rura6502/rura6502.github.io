...
OAuth는 이러한 이슈들을 autorization layer를 분리하고 client에게 Resource Owner로 부터 부여된 적절한 권한을 할당함으로써 풀 수 있다. OAuth는 Resource Owner에게 에
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NDIwMTUzMDgsNDgzODgyMzQ0LC03Mj
Y1OTM3NzEsMTU4ODk1ODU5OF19
-->
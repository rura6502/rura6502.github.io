...
(B) 클라이언트는 '리소스 오너가 승인함'을 표현하는 증명서인 허가 부여(Authorization Grant)를 받는다. 여기서 허가는 사전정의되어 있는 4가지의 grant type 중 하나이거나 
(C) 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU3NDEzMTY5MCwtMzgzMDEwMjk2LC05NT

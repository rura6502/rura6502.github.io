...
권한 코드(Authorization Code)는 인증 서버를 사용함으로써 얻을 수 있는데 클라이언트와 리소스 오너간에 중개인으로써의 인증 서버를 사용할 때 얻을 수 있다. 리소스 오너에게 권한을 요청하는 대신에 클라이언트는 리소스 오너에게 '
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ2MDk4MTE4OCwxMTA0MTczMTIyLC0zOD

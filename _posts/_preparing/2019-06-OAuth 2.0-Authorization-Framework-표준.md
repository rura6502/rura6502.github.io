...
> 개인 사진(비공개기반)을 보관/인쇄해주는 서비스를 가정할 때, 사용자(end-user, Resource Owner)는 printing service(Client)를 이용할 권한이 있고 이미 업로드한 사진(Protected Resource)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NzEzNzMzNiwtMTI5MzU5OTAxMiwyMT

...
보통의 프로그램 코드에서 데이터베이스에 접근할 때 데이터베이스에 접속하기위한 드라이버 로드, 접속, 쿼리, 결과 로딩, 커넧스프링의 `JDBCTemplate`의 경우 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMDU3MjUxMTgsMjEzMDY1MDc3OCwtNj
AwMjI2Njk5LC05MjQ2ODU0NTEsOTE5ODg0NTAzLC0xODk1NDI2
NzczXX0=
-->
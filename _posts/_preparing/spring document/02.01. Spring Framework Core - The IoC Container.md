...
몇몇 `ApplicationContext` 인터페이스의 구현체는 스프링에 의해서 제공된다. 독립형(Stand-alone) 애플리케이션에서 일반적으로 `ClassPathXmlApplicationContext`, `FileSystemXmlApplicationContext`가 많이 사용되며, 모든 메타데이터 설정을 전통적인 포맷인 XML로도 설정할 수 있지만, XML에 애노테이션 도는 코드
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEwODI5NDYwNiw1NzE3MTIxNjksLTcwMj
M3Nzg4MCw0NTY3NjY5NjEsLTE1MDM5ODg5NDcsMTM4OTE1NDg1
MF19
-->
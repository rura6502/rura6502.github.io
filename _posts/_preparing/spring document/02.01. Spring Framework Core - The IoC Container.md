...
개발자가 static factory method를 사용하여 빈을 정의할 때, `class` 속성을 `static` factory method 를 포함하고 있는 class를 적고, `factory-method` 속성에 factory method 이름을 적어라. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDkzMTg5MzEwLDc0NzA0ODgzMSwxNjIyOD

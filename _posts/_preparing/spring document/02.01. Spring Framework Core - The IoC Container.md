...
이후 개발자는 `getBean`을 사용하여 빈의 인스턴스를 얻을 수 있다. `AppliationContext`는 `getBean` 말고도 빈 인스턴스를 얻기 위해 다른 다양한 메소드들을 지원하지만 개발자는 애플리케이션 코드에서 절대 사용하지 않는 것이 좋다. 사실 애플리케이션 사
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzMxMjIyOTM5LDE2MjU1ODM5NjQsNDczNT
QxOTM2LC0xMzkxMTUzMjI4LDExNDY1MDQ3MjQsLTExMzU0Njk0
NiwxMzQ5ODkwMjAyLC00MTA0NzMyNjYsMzI1MDAyMzg4LDE1Nz

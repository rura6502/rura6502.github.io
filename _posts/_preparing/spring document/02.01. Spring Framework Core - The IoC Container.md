...
몇몇 `ApplicationContext` 인터페이스의 구현체는 스프링에 의해서 제공된다. 독립형(Stand-alone) 애플리케이션에서 
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTcxNzEyMTY5LC03MDIzNzc4ODAsNDU2Nz
Y2OTYxLC0xNTAzOTg4OTQ3LDEzODkxNTQ4NTBdfQ==
-->
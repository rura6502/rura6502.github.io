...
이 챕터는 스프링 프레임워크의 IoC 개념에 대하여 다룬다. IoC는 Dependency Injection(DI)로도 알려져 있다. 이것은 객체가 사용하는 의존성을 Constructor Arguments, Arguments to a factory method, Properties로만 정의하고 처리하도록 한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcwMjM3Nzg4MCw0NTY3NjY5NjEsLTE1MD

...
개발자가 static factory method를 사용하여 빈을 정의할 때, `static` factory method를 포함하고 있는  `class`를 사용하면 된다. `factory-method`라고 불리우는 속성
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk2Nzc3NDg2MCw3NDcwNDg4MzEsMTYyMj
g4MDIyOCwtNTA5NjQ4NjA0LC00NjkwMzQ3OTMsLTE5NzgwMDMx
NywtNTI5MTk4NDYyLDk1NDQzNDU4MywxMjc3Njg5ODM2LDIxNz

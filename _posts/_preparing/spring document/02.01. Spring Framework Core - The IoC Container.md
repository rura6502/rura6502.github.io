...
Dependency Injection(이하 DI)는 생성자 주입 방식, 팩토리 메서드 방식, 팩토리 메서드로부터 반환되거나 구성되어 생성되는 객체 인스턴스로 만들어진 프로퍼티 등으로 디펜던시(작업하는 다른 객체)를 정의할 수 있는 프로세스이다. 컨테이너는 이런 디펜던시들을 빈이 생성될때 주입한다. 이런 프로세스는 기본적으로 서비스
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYxMjgwNzQ3MywtNTQwNzA2NjQzLDk1OD
kzMTgyNywxNDc2Nzk2OTY4LDc0NzA0ODgzMSwxNjIyODgwMjI4
LC01MDk2NDg2MDQsLTQ2OTAzNDc5MywtMTk3ODAwMzE3LC01Mj
kxOTg0NjIsOTU0NDM0NTgzLDEyNzc2ODk4MzYsMjE3MzUyMjIw
LC01ODEzMzU2NDYsNDUyMTMyODQ1LDM2NjA5OTcwOSwtMTgyMz
k0MTg5NCwxNjI1NTgzOTY0LDQ3MzU0MTkzNiwtMTM5MTE1MzIy
OF19
-->
...
이전 예제에서 서비스 레이어는 `PetStoreServiceImpl` 클래스와 `JpaAccountDao` 타입의 데이터 엑세스 객체
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODQ2OTMzODkwLC0xODQ5MDAxMTA0LDE3Mj
E4NzUwODUsODQ3NTMwMjMyLC05NDgxMDUwMjIsMTE2NjcwODc5
NSwxOTMyNjMxMDM2LDU3MTcxMjE2OSwtNzAyMzc3ODgwLDQ1Nj

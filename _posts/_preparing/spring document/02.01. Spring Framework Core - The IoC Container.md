...
> 빈 메타데이터와 사용자가 직접 정의하고 제공하는 싱글톤 인스턴스는 컨테이너가 autowring과 introspection을 하는 단계에서 적절하게 추론할 수 있도록 될수있으면 빨리 등록되어야 한다.  기존에 이미 생성되어있는 메타데이터나 싱글톤 인스턴스를 재정의(overriding)오버라이딩하는 것은 지원은 되지만 



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU4MTMzNTY0Niw0NTIxMzI4NDUsMzY2MD

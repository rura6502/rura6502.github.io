...
`static factory method` 방식과 유사하게 instance factory 메소드를 사용한 인스턴스화 방식은 새로운 빈을 생성하기 위해 컨테이너로부터 이미 만들어져 있는 빈의 non-static method를 호출한다. 이 방식은 `class` 속성을 비우고 `factory-bean` 속성에 객체를 만들 수 있는 인스턴스 메소드를 포함하고, 현재 컨테이너에 생성/사용되어지고있는 빈의 이름을 적는다. `factory-method` 속
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5ODA5ODMwMjksMTQ3Njc5Njk2OCw3ND
cwNDg4MzEsMTYyMjg4MDIyOCwtNTA5NjQ4NjA0LC00NjkwMzQ3
OTMsLTE5NzgwMDMxNywtNTI5MTk4NDYyLDk1NDQzNDU4MywxMj
c3Njg5ODM2LDIxNzM1MjIyMCwtNTgxMzM1NjQ2LDQ1MjEzMjg0
NSwzNjYwOTk3MDksLTE4MjM5NDE4OTQsMTYyNTU4Mzk2NCw0Nz
M1NDE5MzYsLTEzOTExNTMyMjgsMTE0NjUwNDcyNCwtMTEzNTQ2
OTQ2XX0=
-->
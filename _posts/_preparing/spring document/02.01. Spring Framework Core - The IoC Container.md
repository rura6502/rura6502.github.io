...
이전의 다이어그램에서 봤듯이 스프링 IoC 컨테이너는 환경설정 메타데이터에 의해서 구성된다. 환경설정 메타데이터는 개발자가 스프링 컨테이너를 어떻게 설정하고, 구성하고 인스턴스화할
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTgzODY1MjQxLDExNjY3MDg3OTUsMTkzMj
YzMTAzNiw1NzE3MTIxNjksLTcwMjM3Nzg4MCw0NTY3NjY5NjEs
LTE1MDM5ODg5NDcsMTM4OTE1NDg1MF19
-->
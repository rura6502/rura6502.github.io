...
빈의 이름을 네밍할때의 필드 이름 인스턴스를 위한 자바 표준 관례(Standard Java Convertion)를 따른다. 이름의 첫 글자는 소문자로 시작하고 그 다음부터는 camel-cased를 사용한다. 예를들어 accountManager, accountService
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwOTAyMjY5MTUsMjE3MzUyMjIwLC01OD

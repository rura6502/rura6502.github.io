...
Dependency Injection(이하 DI)는 생성자 주입 방식, 팩토리 메서드 방식, 팩토리 메서드로부터 반환되거나 구성되어 생성되는 객체 인스턴스로 만들어진 프로퍼티 등으로 디펜던시(작업하는 다른 객체)를 정의할 수 있는 프로세스이다. 컨테이너는 이런 디펜던시들을 빈이 생성될때 주입한다. 이런 프로세스는 인스턴스화를 스스로 컨트롤하는 빈의 역전(더 나은 표현으로 Inversion of Control) 이기도 하며 서비스 로케이터 또는 클래스들의 생성을 사용하여 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwOTUwMTkxODYsLTU0MDcwNjY0Myw5NT
g5MzE4MjcsMTQ3Njc5Njk2OCw3NDcwNDg4MzEsMTYyMjg4MDIy
OCwtNTA5NjQ4NjA0LC00NjkwMzQ3OTMsLTE5NzgwMDMxNywtNT
I5MTk4NDYyLDk1NDQzNDU4MywxMjc3Njg5ODM2LDIxNzM1MjIy
MCwtNTgxMzM1NjQ2LDQ1MjEzMjg0NSwzNjYwOTk3MDksLTE4Mj
M5NDE4OTQsMTYyNTU4Mzk2NCw0NzM1NDE5MzYsLTEzOTExNTMy
MjhdfQ==
-->
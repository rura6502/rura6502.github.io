...
원래 빈 설정에서 사용자는 하나의 `id` 속성과 다수의 `name` 속성 사용해서 하나 이상의 이름을 지정할 수 있다. 이러한 이름들은 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjk3MjgwNTkwLDEyNzc2ODk4MzYsMjE3Mz
...
MiwtNDEwNDczMjY2LDMyNTAwMjM4OCwxNTcyMTU5NzU5LC0xOD

...
`ApplicationContext`를 제공하기 위한 location path 설정은 컨테이너가 여러 외부 리소스들(local file system 또는 Java `CLASSPATH`)로 부터 환경설정 멛
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDk4NjY2MDcyLDE3MjE4NzUwODUsODQ3NT

...
> Inner class names
> 만약 `static`의 중첩 클래스(nested class)를 위한 빈을 정의한다면 중첩 컬래스의 바이너리 네임을 사용해야 한다. 예를들어 `com.example` 패키지의 `SomeThing` 클래스 내부에 중첩 클래스 `OtherThing`이 있다면 


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NDU3ODI2NDcsLTUyOTE5ODQ2Miw5NT
Q0MzQ1ODMsMTI3NzY4OTgzNiwyMTczNTIyMjAsLTU4MTMzNTY0
Niw0NTIxMzI4NDUsMzY2MDk5NzA5LC0xODIzOTQxODk0LDE2Mj
U1ODM5NjQsNDczNTQxOTM2LC0xMzkxMTUzMjI4LDExNDY1MDQ3
MjQsLTExMzU0Njk0NiwxMzQ5ODkwMjAyLC00MTA0NzMyNjYsMz
I1MDAyMzg4LDE1NzIxNTk3NTksLTE4NDkwMDExMDQsMTcyMTg3
NTA4NV19
-->
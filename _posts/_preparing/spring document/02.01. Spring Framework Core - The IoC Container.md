...
#### The Groovy Bean Definition DSL
 ...
 외부화된 환경설정 메타데이터 설정을 위한 이전의 예제 처럼, 빈 설정을 Grails framework로 부터 파생된 스프링의 그루비 빈 설정 DSL(Groovy Bean Definition DSL)로도 할 수 있다. 보통 `".groo
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MzU4OTUxOSwxMTQ2NTA0NzI0LC0xMT
...
MDM2LDU3MTcxMjE2OSwtNzAyMzc3ODgwLDQ1Njc2Njk2MSwtMT
UwMzk4ODk0NywxMzg5MTU0ODUwXX0=
-->
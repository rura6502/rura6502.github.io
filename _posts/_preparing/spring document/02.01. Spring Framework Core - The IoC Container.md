...
> 클래스패스에서 컴포넌트 스캐닝(Component Scanning)을 사용하면 스프링은 이름이 지정되지 않은 컴포넌트의 이름을 자동으로 생성하고 배정하는데 이전에 소개한 룰을 따른다. 기본적으로 클래스 이름을 사용하는데 첫번째 글자는 소문자로 바꾼다. 첫번째와 두번째 글자가 대문자인 경우와 같은 특별한 경우 ㅇ
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ0OTY5Mjg1NCwxMjc3Njg5ODM2LDIxNz
M1MjIyMCwtNTgxMzM1NjQ2LDQ1MjEzMjg0NSwzNjYwOTk3MDks
LTE4MjM5NDE4OTQsMTYyNTU4Mzk2NCw0NzM1NDE5MzYsLTEzOT

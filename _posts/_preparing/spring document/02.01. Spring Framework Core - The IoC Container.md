...
세터를 사용한 DI는 기본 생성자(no-argument constructor) 또는 인자가 없는 `sttia컨테이너가 빈안에 있는 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE0NzY0NDA4MiwxNjM2NDUyOTEwLC01ND
...
NiwyMTczNTIyMjAsLTU4MTMzNTY0Niw0NTIxMzI4NDUsMzY2MD

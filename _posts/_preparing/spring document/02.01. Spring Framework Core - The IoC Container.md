...
빈 설정을 여러 XML 파일에 하는 것은 유용한다. 종종 개별 XML 설정 파일을 아키텍쳐의 모듈 또는 논리적 레이어를 표현한다. 개발자는 모든 XML fragment들로부터 빈 설정을 읽기위해 애플리케이션 콘텍스트 생성자를(application context construct) 사용할 수 있다.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNDA0OTU1MDQsMzI1MDAyMzg4LDE1Nz

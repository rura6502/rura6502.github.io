...
위 설정에서 `id` 속성은 각각의 빈 정의를 구분하기 위한 문자열 속성이며 `class` 속성은 빈의 타입을 정의하기 위한 fully qualified classname(패키지 명을 포함한 풀 클래스 네임) 이다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjE5NTk5NDEyLDE3MjE4NzUwODUsODQ3NT
MwMjMyLC05NDgxMDUwMjIsMTE2NjcwODc5NSwxOTMyNjMxMDM2
LDU3MTcxMjE2OSwtNzAyMzc3ODgwLDQ1Njc2Njk2MSwtMTUwMz
k4ODk0NywxMzg5MTU0ODUwXX0=
-->
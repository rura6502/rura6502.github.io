...
생성자 접근법으로 빈을 생성하면 모든 일반 클래스들은 스프링에 의해 사용 가능하고 호환 가능하다. 즉 개발중인 클래스는 특정 인터페이스를 구현하거나 특정 방식으로 코딩할 필요가 없다. 간단하게 빈 클래스를 나열하는 것도 가능하다. 


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcyMDQ2Nzc3OCwtNTA5NjQ4NjA0LC00Nj

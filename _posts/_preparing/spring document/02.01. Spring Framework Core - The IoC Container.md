...
이러한 빈들의 정의는 실제 사용자 애플리케이션을 만드는 객체로 구성되어 있다. 일반적으로 사용자는 Service Layer Objects, Data Access Objects(DAOs), Present
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc4NTM0OTU3NywxNzIxODc1MDg1LDg0Nz

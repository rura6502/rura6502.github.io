...
`static factory method` 방식과 유사하게 instance factory 인스메소드는 새로운 빈을 생성하기 위해 컨테이너로부터 이미 만들어져 있는 빈의 non-static method를 호출한다. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU3MjMzMjg2MiwxNDc2Nzk2OTY4LDc0Nz

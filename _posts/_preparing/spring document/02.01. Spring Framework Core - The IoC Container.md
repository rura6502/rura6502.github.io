...
`org.springframework.context.ApplicationContext` 인터페이스는 스프링 IoC 컨테이너를 대표하고 빈의 인스턴스, 설정, 조립에 대한 책임을 가진다. 컨테이너는 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwODcxMzI3MDIsLTcwMjM3Nzg4MCw0NT

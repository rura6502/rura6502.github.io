...
> 만약 생성자 주입방식을 사용한다면 순환 종속성을 방지할 수 잇다. 예를들어 `ClassA`가 `ClassB`의 인스턴스를 생성자 주입 방식으로 주입하고 `ClassB`가 `ClassA`의 인스턴스를 생성자
<!--stackedit_data:
eyJoaXN0b3J5IjpbODQ1ODY1ODAyLC0xMjUxNjgxNjAwLDQ1Nj
k5NTI2OSwtMTAwMDE0NDQyOSwtMzU4NjM5Mzg0LC00NjExMzcx
MzAsMTQzNzMwMjcxLC0xMTU4OTE3ODUsMjE1MzQwMTM2LDE2Mz
Y0NTI5MTAsLTU0MDcwNjY0Myw5NTg5MzE4MjcsMTQ3Njc5Njk2
OCw3NDcwNDg4MzEsMTYyMjg4MDIyOCwtNTA5NjQ4NjA0LC00Nj

...
이전 예제에서 서비스 레이어는 `PetStoreServiceImpl` 클래스와 `JpaAccountDao` 타입과 `JpaItemDao` 타입(JPA Object-Relational Mapping standard)의 데이터 엑세스 객체 2개로 이루어져 있다. `
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ2MDM4Nzk4NSwxNTcyMTU5NzU5LC0xOD

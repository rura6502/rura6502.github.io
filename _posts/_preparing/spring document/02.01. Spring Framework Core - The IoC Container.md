...
이 챕터는 스프링 프레임워크의 IoC 개념에 대하여 다룬다. IoC는 Dependency Injection(DI)로도 알려져 있다. 이것은 객체가 사용하는 의존성을 Constructor Arguments, Arguments to a factory method, Properties, 리턴된 객체 인스턴스에 설정된 특성으로만 정의하고 처리하도록 한다. 컨테이는 빈을 생성할 때 필요한 의존성을 주입하고 이러한 프로세스는 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ1MTIzMTEzMiwtNzAyMzc3ODgwLDQ1Nj

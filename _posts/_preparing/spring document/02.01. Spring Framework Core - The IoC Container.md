...
> 빈 메타데이터와 사용자가 직접 정의하고 제공하는 싱글톤 인스턴스는 컨테이너가 autowring과 introspection을 하는 단계에서 적절하게 추론할 수 있도록 될수있으면 빨리 등록되어야 한다.  기존에 이미 생성되어있는 메타데이터나 싱글톤 인스턴스를 재정의(overriding)오버라이딩하는 것은 어느정도 지원되지만 런타임에서 새로운 빈을 등록하는 것은 공식적으로 지원하지 않으며 concurrent access exception 을 발생시키거나 빈 컨테이너의 일관성 없는 상태를 발



<!--stackedit_data:
eyJoaXN0b3J5IjpbNDM5MjA2NTI2LC01ODEzMzU2NDYsNDUyMT
MyODQ1LDM2NjA5OTcwOSwtMTgyMzk0MTg5NCwxNjI1NTgzOTY0
LDQ3MzU0MTkzNiwtMTM5MTE1MzIyOCwxMTQ2NTA0NzI0LC0xMT
M1NDY5NDYsMTM0OTg5MDIwMiwtNDEwNDczMjY2LDMyNTAwMjM4
OCwxNTcyMTU5NzU5LC0xODQ5MDAxMTA0LDE3MjE4NzUwODUsOD
Q3NTMwMjMyLC05NDgxMDUwMjIsMTE2NjcwODc5NSwxOTMyNjMx
MDM2XX0=
-->
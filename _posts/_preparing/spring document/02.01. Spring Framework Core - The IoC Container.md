...
> 스프링은 `Resource` 추상체를 사용하여 개발자가 URI syntax를 이용하여 위치를 정의하고 InputStream으로 읽어서 설정할 수 있도록 도와준다. 실제로 `Resource` 패스는 애플리케이션 컨텍스트를 구성하고 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI2OTk5MjQzNiwtMTg0OTAwMTEwNCwxNz

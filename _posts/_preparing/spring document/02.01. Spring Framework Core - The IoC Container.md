...
예를들어 서브시스템 A의 환경설정 메타데이터가 `subsystemA-datasource`라는 이름의 DataSource를 참조하고 서브시스템 B의 환경설정 메타데이터는 `subsystemB-dataSource`라는 이름의 DataSource를 참조할 때 


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg0ODc4MTE5NCw5NTQ0MzQ1ODMsMTI3Nz
Y4OTgzNiwyMTczNTIyMjAsLTU4MTMzNTY0Niw0NTIxMzI4NDUs
MzY2MDk5NzA5LC0xODIzOTQxODk0LDE2MjU1ODM5NjQsNDczNT

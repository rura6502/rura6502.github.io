...
> 생성자 방식과 세터 방식을 섞어 쓸 수 있으므로 생성자 방식을 통하여 먼저 필수적인 디펜던시를 주입하고 세터 메소드 또는 환경설정 메소드를 통하여 선택적인 디펜던시를 주입하는 것이 좋은 방법이 될 수 잇다. 세터 메소드에 `@Required` 애노테이션을 붙이는 것은 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzEwNDM2MDUwLC0xMTU4OTE3ODUsMjE1Mz

...
개발자가 static factory method를 사용하여 빈을 정의할 때, `class` 속성을 `static` factory method 를 포함하고 있는 class를 적고, `factory-method` 속성에 factory method 이름을 적어라. 개발자는 이 메소드를 콜 할수 있고 컨테이너를 통해 생성되어 유지되고 있는 살아있는 오브젝트(live object)를 반환해야 한다.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MzQzODYwNzAsNzQ3MDQ4ODMxLDE2Mj
I4ODAyMjgsLTUwOTY0ODYwNCwtNDY5MDM0NzkzLC0xOTc4MDAz
MTcsLTUyOTE5ODQ2Miw5NTQ0MzQ1ODMsMTI3NzY4OTgzNiwyMT
czNTIyMjAsLTU4MTMzNTY0Niw0NTIxMzI4NDUsMzY2MDk5NzA5
LC0xODIzOTQxODk0LDE2MjU1ODM5NjQsNDczNTQxOTM2LC0xMz
kxMTUzMjI4LDExNDY1MDQ3MjQsLTExMzU0Njk0NiwxMzQ5ODkw
MjAyXX0=
-->
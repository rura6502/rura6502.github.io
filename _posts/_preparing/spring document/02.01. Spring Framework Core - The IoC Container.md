...
예를들어 서브시스템 A의 환경설정 메타데이터가 `subsystemA-datasource`라는 이름의 DataSource를 참조하고 서브시스템 B의 환경설정 메타데이터는 `subsystemB-dataSource`라는 이름의 DataSource를 참조한다고 하자. 두 시스템을 모두 이용하는 메인 시스템을 구성할 경우 메인 시스템의 DataSource는 `myApp-dataSource`라고 하면 


<!--stackedit_data:
eyJoaXN0b3J5IjpbNjI0NDY0NDQ3LDk1NDQzNDU4MywxMjc3Nj
g5ODM2LDIxNzM1MjIyMCwtNTgxMzM1NjQ2LDQ1MjEzMjg0NSwz
NjYwOTk3MDksLTE4MjM5NDE4OTQsMTYyNTU4Mzk2NCw0NzM1ND
E5MzYsLTEzOTExNTMyMjgsMTE0NjUwNDcyNCwtMTEzNTQ2OTQ2
LDEzNDk4OTAyMDIsLTQxMDQ3MzI2NiwzMjUwMDIzODgsMTU3Mj
E1OTc1OSwtMTg0OTAwMTEwNCwxNzIxODc1MDg1LDg0NzUzMDIz
Ml19
-->
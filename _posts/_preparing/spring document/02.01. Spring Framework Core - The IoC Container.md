...
개발자가 static factory method를 사용하여 빈을 정의할 때, `class` 속성을 `static` factory method 를 포함하고 있는 class를 적고, `factory-method` 속성에 factory method 이름을 적어라. 개발자는 이 메소드를 콜 할수 있고 살아있는 오브젝트(live object)를 반환해야 한다. 이것은 마치 생성자를 통해 생성된것 처럼 다루어진다.
<!--stackedit_data:
eyJoaXN0b3J5IjpbODI2NzYwNDEwLDc0NzA0ODgzMSwxNjIyOD
gwMjI4LC01MDk2NDg2MDQsLTQ2OTAzNDc5MywtMTk3ODAwMzE3
LC01MjkxOTg0NjIsOTU0NDM0NTgzLDEyNzc2ODk4MzYsMjE3Mz
UyMjIwLC01ODEzMzU2NDYsNDUyMTMyODQ1LDM2NjA5OTcwOSwt
MTgyMzk0MTg5NCwxNjI1NTgzOTY0LDQ3MzU0MTkzNiwtMTM5MT
E1MzIyOCwxMTQ2NTA0NzI0LC0xMTM1NDY5NDYsMTM0OTg5MDIw
Ml19
-->
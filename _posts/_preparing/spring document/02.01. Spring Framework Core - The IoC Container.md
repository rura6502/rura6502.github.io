...
스프링 컨테이너는 컨테이너에서 생성된 각각의 빈 설정을 검증한다. 그러나 빈 프로퍼티는 실제로 빈이 생성되기 전까지 세팅되지 스스로 세팅되지 않는다. 컨테이너가 생성될 때 싱글톤 빈, 사전 인스턴스화 되도록 설정된 빈이 생성된다. 빈의 범위는 `Bean Scopes`에 의해서 ㅈ
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNjA1NTQ1MzUsNDU2OTk1MjY5LC0xMD
AwMTQ0NDI5LC0zNTg2MzkzODQsLTQ2MTEzNzEzMCwxNDM3MzAy
NzEsLTExNTg5MTc4NSwyMTUzNDAxMzYsMTYzNjQ1MjkxMCwtNT
QwNzA2NjQzLDk1ODkzMTgyNywxNDc2Nzk2OTY4LDc0NzA0ODgz
MSwxNjIyODgwMjI4LC01MDk2NDg2MDQsLTQ2OTAzNDc5MywtMT
k3ODAwMzE3LC01MjkxOTg0NjIsOTU0NDM0NTgzLDEyNzc2ODk4
MzZdfQ==
-->
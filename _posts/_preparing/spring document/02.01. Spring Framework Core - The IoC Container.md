...
빈 설정을 여러 XML 파일에 하는 것은 유용한다. 종종 개별 XML 설정 파일을 아키텍쳐의 모듈 또는 논리적 레이어를 표현한다. 개발자는 모든 XML fragment들로부터 빈 설정을 읽기위해 애플리케이션 콘텍스트 생성자(application context construct)를 사용할 수 있다.  아래의 생성자는 여러 `Resource`를 가진다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM0OTg5MDIwMiwtNDEwNDczMjY2LDMyNT
AwMjM4OCwxNTcyMTU5NzU5LC0xODQ5MDAxMTA0LDE3MjE4NzUw
ODUsODQ3NTMwMjMyLC05NDgxMDUwMjIsMTE2NjcwODc5NSwxOT
MyNjMxMDM2LDU3MTcxMjE2OSwtNzAyMzc3ODgwLDQ1Njc2Njk2
MSwtMTUwMzk4ODk0NywxMzg5MTU0ODUwXX0=
-->
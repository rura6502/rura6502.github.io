...
정리하자면 `BeanFactory`는 기본적인 프레임워크의 기능과 환경설정을 할 수있도록 제공하며 `ApplicationContext`는 엔터프라이즈 기능을 위한 더 많은 기능을 지원한다고 정리할 수 있다. `ApplicationContext`는 `BeanFactory`의 superset이며 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMTkwNDE0MTMsLTcwMjM3Nzg4MCw0NT

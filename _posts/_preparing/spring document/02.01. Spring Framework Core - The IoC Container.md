...
ThingTwo, ThingThree가 아무 관계없는 객체라고 가정했을 때 위 예제는 아무런 모호함이 없다. 그러므로 아래의 환경설정은 문제없이 동작하며 개발자는 생성자의 인자 인덱스 또는 타입을 명시적으로 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ1NDc3NTIyOCwtNTQwNzA2NjQzLDk1OD

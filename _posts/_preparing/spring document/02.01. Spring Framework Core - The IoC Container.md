...
생성자 접근법으로 빈을 생성하면 모든 일반 클래스들은 스프링에 의해 사용 가능하고 호환 가능하다. 즉 개발중인 클래스는 특정 인터페이스를 구현하거나 특정 방식으로 코딩할 필요가 없다. 간단하게 빈 클래스를 나열하는 것으로 충분하다


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYyMjg4MDIyOCwtNTA5NjQ4NjA0LC00Nj
kwMzQ3OTMsLTE5NzgwMDMxNywtNTI5MTk4NDYyLDk1NDQzNDU4
MywxMjc3Njg5ODM2LDIxNzM1MjIyMCwtNTgxMzM1NjQ2LDQ1Mj
EzMjg0NSwzNjYwOTk3MDksLTE4MjM5NDE4OTQsMTYyNTU4Mzk2
NCw0NzM1NDE5MzYsLTEzOTExNTMyMjgsMTE0NjUwNDcyNCwtMT
EzNTQ2OTQ2LDEzNDk4OTAyMDIsLTQxMDQ3MzI2NiwzMjUwMDIz
ODhdfQ==
-->
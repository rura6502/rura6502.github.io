...
XML 기반의 환경설정 메타데이터에서 `id`과 `name` 속성을 사용하여 빈을 구분할 수 있으며 둘 다 쓸수도 있다. 아이디 속성은 하나만 선언할 수 있으며 관례적으로 영문과 숫자로 이루어져 myBean, someService 와 같은 형태로 네이밍 한다. 특수문자도 쓸 수 있다. `name` 속성의 경우 콤마( , ), 세미콜론( ; ), 공백  



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMjk5Nzk3MzksMjE3MzUyMjIwLC01OD
EzMzU2NDYsNDUyMTMyODQ1LDM2NjA5OTcwOSwtMTgyMzk0MTg5
NCwxNjI1NTgzOTY0LDQ3MzU0MTkzNiwtMTM5MTE1MzIyOCwxMT
Q2NTA0NzI0LC0xMTM1NDY5NDYsMTM0OTg5MDIwMiwtNDEwNDcz
MjY2LDMyNTAwMjM4OCwxNTcyMTU5NzU5LC0xODQ5MDAxMTA0LD
E3MjE4NzUwODUsODQ3NTMwMjMyLC05NDgxMDUwMjIsMTE2Njcw
ODc5NV19
-->
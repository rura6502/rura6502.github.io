...
> 클래스패스에서 컴포넌트 스캐닝(Component Scanning)을 사용하면 스프링은 이름이 지정되지 않은 컴포넌트의 이름을 자동으로 생성하고 배정하는데 이전에 소개한 룰을 따른다. 필수적으로 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI3NzY4OTgzNiwyMTczNTIyMjAsLTU4MT

...
DI 개념을 사용하면 코드는 깔끔해지고 객체들에 종속성을 제공할 때 훨씬 더 효율적으로 디커플링된다. 객체들은 디펜던시들을 더 이상 찾지않고 어떤 디펜던시의 클래스가 필요한지, 어디에 있는지를 알 필요가 없다. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk4MzQ2Mzg3OCwtNTQwNzA2NjQzLDk1OD

...
만약 순환 참조의 문제가 없다면 하나 또는 여러개의 협력들을 가지는 빈들이 연관 성있는 빈으로 주입될 때 각각의 협업하는 빈들은 전적으로 연관ㄷ뇌 빈으로 주입되는 것 이전에 설정된다.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAxMjEwODAyOSwtMzk1NTYzNzA1LC0xMj

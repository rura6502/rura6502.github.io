...
스프링 컨테이너는 컨테이너에서 생성된 각각의 빈 설정을 검증한다. 그러나 빈 프로퍼티는 실제로 빈이 생성되기 전까지 세팅되지 스스로 세팅되지 않는다. 컨테이너가 생성될 때 싱글톤 빈, 사전 인스턴스화 되도록 설정된 빈이 생성된다. 빈의 범위는 `Bean Scopes`에 의해서 정의된다. 별도로 설정하지 않으면 빈은 리퀘스트가 일어날 때 생성된다. 잠재적으로 빈의 생성은 
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTczMTYyNTk4LDQ1Njk5NTI2OSwtMTAwMD
E0NDQyOSwtMzU4NjM5Mzg0LC00NjExMzcxMzAsMTQzNzMwMjcx
LC0xMTU4OTE3ODUsMjE1MzQwMTM2LDE2MzY0NTI5MTAsLTU0MD
cwNjY0Myw5NTg5MzE4MjcsMTQ3Njc5Njk2OCw3NDcwNDg4MzEs
MTYyMjg4MDIyOCwtNTA5NjQ4NjA0LC00NjkwMzQ3OTMsLTE5Nz
gwMDMxNywtNTI5MTk4NDYyLDk1NDQzNDU4MywxMjc3Njg5ODM2
XX0=
-->
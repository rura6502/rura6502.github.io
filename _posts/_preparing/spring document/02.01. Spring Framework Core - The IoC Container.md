...
이러한 빈들의 정의는 실제 사용자 애플리케이션을 만드는 객체로 구성되어 있다. 일반적으로 사용자는 Service Layer Objects, Data Access Objects(DAOs), Presentation Objects(ex. Struts의 `Action`), Infrastructure Objects(ex. Hibernate의 `SessionFactories`), JMS `Queues` 등의 서비스를 정의한다. 또한 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMTE0NDQ4OTIsMTcyMTg3NTA4NSw4ND
c1MzAyMzIsLTk0ODEwNTAyMiwxMTY2NzA4Nzk1LDE5MzI2MzEw
MzYsNTcxNzEyMTY5LC03MDIzNzc4ODAsNDU2NzY2OTYxLC0xNT
AzOTg4OTQ3LDEzODkxNTQ4NTBdfQ==
-->
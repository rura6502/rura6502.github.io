...
스프링 프레임워크 5.0에서는 Java EE 7(Servlet 3.1+, JPA 2.1+)를 기본적으로 지원하며 JAva EE 8(Servlet 4.0, JSON Binding API)도 바로 사용할 수 있을 정도의 레벨로 지원한다. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTA3ODE4NjIwLC0xODIzNTg4MDM4LC0xMz

...
애플리케이션 개발은 시간이 지남에 따라 점점 많이 변화되어 왔다. 스프링과 Java EE 초창기에 애플리케이션은 애플리케이션 서버에 배포되기 위해 만들어졌다. 오늘날 스프링 부트는 데브옵스(devops)와 클라우드 친화적인 방법으로 개발할 수 있도록 도와주고
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMwMDI5OTM2OSw4NTkxMjUxMjIsMTY3ND
g4NzQyMiwtMTgyMzU4ODAzOCwtMTM3NDU1NTc1NiwxMTYyNTcx
NTEyLC0xNDQxOTExODk1LDEwNjMxNzYwNjJdfQ==
-->
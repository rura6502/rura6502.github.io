...
프레임워크에 대해서 공부할 때 스프링 프레임워크의 핵심 개념에 대하여 중점적으로 보야아할 점은 아래와 같다.

* 모든 레벨에서의 선택을 제공한다. 스프링은 별도의 코드 변화 없이 단지 환경설정을 바꿈으로써 영속성을 변경하는 등의 유연함을 제공한다.(Spring lets you defer design decisions as late as possible). 
* 다양성을 추구한다. 스프링은 유연하고 여러가지 관점에서의 애플리케이션 요구사항을 지원한다.
* 다양한 버전에 대한 호환성을 제공한다. JDK 버전과 서터파티 라이브러리에 대한 
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTA4Mzg2NzIzLC0xMDQ5NDAzMjUxLDE4Nz
c1OTQ0NDgsMTQ5NjI1NTQ0LC0xOTM1ODA5OTM5LDc0Nzg2Mjc5
LC0zMDAyOTkzNjksODU5MTI1MTIyLDE2NzQ4ODc0MjIsLTE4Mj
M1ODgwMzgsLTEzNzQ1NTU3NTYsMTE2MjU3MTUxMiwtMTQ0MTkx
MTg5NSwxMDYzMTc2MDYyXX0=
-->
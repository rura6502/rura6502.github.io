...
스프링은 J2EE 스펙의 복잡성을 극복하기 위하여 2003년에 시작되었으며 사실 Spring은 Java EE를 보완하고 있다. 스프링 프로그래밍 모델은 Java EE 플랫폼 명세를 포함하지는 않으며 오히러 EE에서 선별된 각 개별 

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY5NjU5OTA1NiwtMTgyMzU4ODAzOCwtMT

...
## refer to
[https://docs.oracle.com/javase/10/docs/api/java/util/concurrent/Future.html](https://docs.oracle.com/javase/10/docs/api/java/util/concurrent/Future.html)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg1ODkzNzY5MiwtOTEzNzU2MTk0LDgwOD

...
## refer to
[https://docs.oracle.com/javase/10/docs/api/index.html?java/util/concurrent/Future.html](https://docs.oracle.com/javase/10/docs/api/index.html?java/util/concurrent/Future.html)
[Future (Java SE 10 & JDK 10)](https://docs.oracle.com/javase/10/docs/api/java/util/concurrent/Future.html)
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg1OTg1NTgxMCwtOTEzNzU2MTk0LDgwOD

...
B. 클라이언트는 리소스 오너에게 인증정보를 받습니다. 여기서 인증 정보란 지금의 리소스 오너가 진짜 리소스 오너인지를 검증하는 인증정보입니다. 이 인증정보의 형태(grant type)는 OAuth 2.0에서는 기본적으로 4가지 방식과 추가 extension을 정의하고 있습니다. 어떤 인증정보 형태를 사용하는지는 인증서버
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM1MDIzNDgzMCwtNjYzMzM0MDg0LC0xMD

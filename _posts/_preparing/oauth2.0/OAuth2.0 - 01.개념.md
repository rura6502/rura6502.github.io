...
* Client : Resource Owner을 대신해서 보호되어 있는 리소스에 접근하기 위한 요청을 만드는 애플리케이션입니다. 여기서 클라이언트란 애플리케이션을 실행하는 서버, 데크스탑, 장비 등 다양한 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgyODI3ODY0OCwxMDI3MTMyMzQ4XX0=
-->
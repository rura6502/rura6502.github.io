...
쿠버넷 클러스터에 추가된 리눅스가 설치된 머신. 쿠버넷 클러스터는 여러개의 노드로 구성되어 있으머 물리/가상 머신 모두 가능(미니큐브의 경우 모두 가상머신). 쿠버넷은 팟을 서로 연결하고 외부로 링크시키며 리소스 사용량을 

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAxNjkwODAzOCw4MjI5ODg5MzIsLTIyMz
c5MTg5NCw2MTIyMjA3ODQsMTg1OTMwMTgwMiwxMTc4OTkzNDky
LC02OTE3MTc0NTAsLTE0NjMwOTU1OTAsNjgxNjkzODY4XX0=
-->
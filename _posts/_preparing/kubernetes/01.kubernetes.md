...
실제 환경에서 쿠버넷 사용시 일반적으로 실행되고 있는 모든 팟에 대한 목록 및 상태 정보가 필요함. 쿠버넷은 팟과 팟을 구성하는 컨테이너의 상태를 관리하고 리포팅함. 컨테이너의 상태느 Running, Terminated, Waiting
* 팟의 라이프 사이클 : Phase(Pending, Running, Succeed, Fail, Unknown), PodStatus
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc2Njc3NjM1MCwtMjIzNzkxODk0LDYxMj
IyMDc4NCwxODU5MzAxODAyLDExNzg5OTM0OTIsLTY5MTcxNzQ1
MCwtMTQ2MzA5NTU5MCw2ODE2OTM4NjhdfQ==
-->
...
```bash
$kubectl get pods --all-namespaces  #팟 목록 확인
$kubectl get services --all-namespace  #서비스 목록 확인
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIyMzc5MTg5NCw2MTIyMjA3ODQsMTg1OT
MwMTgwMiwxMTc4OTkzNDkyLC02OTE3MTc0NTAsLTE0NjMwOTU1
OTAsNjgxNjkzODY4XX0=
-->
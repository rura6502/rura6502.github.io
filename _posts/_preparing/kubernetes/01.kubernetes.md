...
팟은 컨테이너의 상태 정보를 체크할 수 있는 프로브(Probe)를 포함할 수 있으며 livenessProbe, readnessProbe 두 종의 프로브가 
<!--stackedit_data:
eyJoaXN0b3J5IjpbODIyOTg4OTMyLC0yMjM3OTE4OTQsNjEyMj
IwNzg0LDE4NTkzMDE4MDIsMTE3ODk5MzQ5MiwtNjkxNzE3NDUw
LC0xNDYzMDk1NTkwLDY4MTY5Mzg2OF19
-->
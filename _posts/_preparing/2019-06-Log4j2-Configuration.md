...
Log4j의 구조. Application은 Logger를 통해서 Log4j에 접근한다. Logger는 고유의 이름을 가지고 LogManager에 의해서 생성된다. LogManager는 LoggerContext에 있는데 이 LoggerContext는 Configuration과 함께 전체 로그 시스템의 core를 이룬다. loggerConfig는 환경설정 내부에 선언된 Logger 선언에 의해서 생성되는데 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzg1NzM4Nzg1LDEyODAzNjY2OTAsODQ2OD
E5NTc1LC0xNDAwMjAxNDYzLDIwMzgzNzY1MTFdfQ==
-->
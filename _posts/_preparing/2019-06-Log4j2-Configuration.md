...
logger를 통하여 전송되는 각각의 로깅 리퀘스트는 그 Logger가 가지고 있는 모든 LoggerConfig에 선언되어 있는 Appenders와 LoggerConfig의 부모의 Appenders에게도 전송됨. 

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY5MTg1MTM5MiwtNDQ0OTAyNDc4LDEyOD

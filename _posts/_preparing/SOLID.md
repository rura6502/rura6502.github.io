...
다시 OCP로 돌아가자면, 이 예제에서 **이 세상에서 개발되어있는, 또 앞으로 개발될 주변기기**는 **확장(앞으로 개발될)이 필요한 클래스**이고 **USB 규격**은 **추상화된 형태**, **메인보드**는 변화가 없어야 하는 클래스**이다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMDAxNzU4MTEsLTM3NzcwODMyLC0xOD

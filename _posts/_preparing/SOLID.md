...
어떻게 기능이 추가되었음에도 그 기능을 쓰는 부분의 변화 없이 쓸 수 있을까? 답은 **추상화**에 있다. 서로 연관되어야 하는 클래스가 직접적으로 연관되지 않고 추상화된 객체가 중간 레이어 역할을 한다면, 확장을 해야하는 클래스에서는 약
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI4NzE0NzIwNywtMzc3NzA4MzIsLTE4Mz

...
* newSingleSthreadExecutor : 쓰레드를 하나만 운용. 하나만 운용하므로 Thread-Safe(동기화 문제가 발생하지 않음)를 보장함. ```newFixedThreadPool(1)```과 똑같이 동작함.
* 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYxMzQxNzQ4NCwtNTc2MDM1MDk4LC0xOT
g3OTkyMDAsLTEyNTc0OTMwNTYsMTIwMDIzNjM1NiwtMjA2MzY1
MDEyMSwtMTkyMzQ2NzE2NSwtMTA2MTQxMTUyNywyMTEzMzkwMT
Q1LC04ODk3MjE2ODBdfQ==
-->